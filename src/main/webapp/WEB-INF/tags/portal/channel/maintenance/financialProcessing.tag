...
<div class="body">
    ...
    <ul class="chan">
        ...
        <li><portal:portalLink displayTitle="true" title="Disbursement Voucher Batch Defaults" url="kr/lookup.do?methodToCall=search&businessObjectClassName=com.rsmart.kuali.kfs.fp.businessobject.DisbursementVoucherBatchDefault&docFormKey=88888888&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true" /></li>
