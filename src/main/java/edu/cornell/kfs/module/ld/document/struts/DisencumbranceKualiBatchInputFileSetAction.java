    ...
    public ActionForward save(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        for (String fileType : uploadedFiles.keySet()) {
            ...
            if (uploadedFile == null || uploadedFile.getInputStream() == null || uploadedFile.getInputStream().available() == 0) {
                ...
                if(fileType.equalsIgnoreCase(KFSConstants.DATA_FILE_TYPE)){
                ...
                disencumFileInputStream = ldService.createDisencumbrance(uploadedFile.getInputStream());
                ...
                typeToStreamMap.put(fileType, disencumFileInputStream);
                }
                else{
