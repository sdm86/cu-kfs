...
public interface PurchasingAccountsPayableModuleService {
    ...
    public void handlePurchasingBatchCancels(String documentNumber, String financialSystemDocumentTypeCode, boolean primaryCancel, boolean disbursedPayment, boolean crCancel, String crCancelMaintDocNbr);
