...
//        return poDocument;
        return copyNotesAndAttachmentsToPO(reqDocument, poDocument);  // mjmc ******************
    }


    // mjmc *************************************************************************************************
    public PurchaseOrderDocument copyNotesAndAttachmentsToPO(RequisitionDocument reqDoc, PurchaseOrderDocument poDoc) {

        purapService.saveDocumentNoValidation(poDoc);
        List<Note> notes = (List<Note>) reqDoc.getBoNotes();
