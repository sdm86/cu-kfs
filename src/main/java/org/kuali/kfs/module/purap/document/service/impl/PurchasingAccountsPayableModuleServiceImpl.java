...
public class PurchasingAccountsPayableModuleServiceImpl implements PurchasingAccountsPayableModuleService {
    ...
    /**
     * @see org.kuali.kfs.integration.pdp.service.PurchasingAccountsPayableModuleService#addAssignedAssetNumbers(java.lang.Integer,
     *      java.util.List)
     */
    ...
    /**
     * @see org.kuali.kfs.integration.pdp.service.PurchasingAccountsPayableModuleService#getPurchaseOrderInquiryUrl(java.lang.Integer)
     */
    ...
    /**
     * @see org.kuali.kfs.integration.pdp.service.PurchasingAccountsPayableModuleService#getAllSensitiveDatas()
     */
    ...
    /**
     * @see org.kuali.kfs.integration.pdp.service.PurchasingAccountsPayableModuleService#getSensitiveDataByCode(java.lang.String)
     */
    ...
    /**
     * @see org.kuali.kfs.integration.pdp.service.PurchasingAccountsPayableModuleService#isPurchasingBatchDocument(java.lang.String)
     */
     ...
     */
    public void handlePurchasingBatchCancels(String documentNumber, String documentTypeCode, boolean primaryCancel, boolean disbursedPayment, boolean crCancel, String crCancelMaintDocNbr) {
        ...
        String crCmCancelNote = parameterService.getParameterValue(PaymentRequestDocument.class, PurapParameterConstants.PURAP_CR_CM_CANCEL_NOTE);
            ...
            if (pr != null) {
                if (disbursedPayment || primaryCancel || crCancel) {
                    if (!crCancel) {
                        ...
                        String crCancelNote = crPreqCancelNote + crCancelMaintDocNbr;
                        paymentRequestService.cancelExtractedPaymentRequest(pr, crCancelNote);
                    }
                }
                else {
            ...
            if (cm != null) {
                if (disbursedPayment || primaryCancel || crCancel) {
                    if (!crCancel) {
                        ...
                        String crCancelNote = crCmCancelNote + crCancelMaintDocNbr;
                        creditMemoService.cancelExtractedCreditMemo(cm, crCancelNote);
                    }
                }
                else {
    ...
    /**
     * @see org.kuali.kfs.integration.pdp.service.PurchasingAccountsPayableModuleService#handlePurchasingBatchPaids(java.lang.String)
     */
