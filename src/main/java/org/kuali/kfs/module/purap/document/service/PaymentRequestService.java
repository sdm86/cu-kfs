...
public interface PaymentRequestService extends AccountsPayableDocumentSpecificService {
    ...
    /**
     * Obtains a list of payment request documents given the purchase order id and status.
     * 
     * @param poDocId  The purchase order id to be used to obtain a list of payment request documents.
     * @param status   The purchase order status to be used to obtain a list of payment request documents.
     * @return         The List of payment request documents numbers given the purchase order id.
     */
